...
#check mpo_recursor_step_precedence_holds
#check packaged_w1_success_exposes_permitted_import
...
example : OperatorKO7.MetaMPO.symPrec OperatorKO7.MetaMPO.Sym.app OperatorKO7.MetaMPO.Sym.recΔ := by
  exact mpo_recursor_step_precedence_holds

example : PermittedW1Import mpo_w1_success.importClass := by
  exact packaged_w1_success_exposes_permitted_import mpo_w1_success
...
example : PermittedW1Import poly_w1_success.importClass := by
  exact packaged_w1_success_exposes_permitted_import poly_w1_success
