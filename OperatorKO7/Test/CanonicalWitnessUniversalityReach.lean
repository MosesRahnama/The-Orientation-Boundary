...
#check @ko7CanonicalWitness_declaredClosedFirability
#check @textbookCanonicalWitness_declaredClosedFirability
#check @taggedBinaryCanonicalWitness_declaredClosedFirability
#check @depthCounterCanonicalWitness_declaredClosedFirability
#check @ko7CanonicalWitness_projects_to_kernel_step
