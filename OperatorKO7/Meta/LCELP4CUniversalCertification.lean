...
Universal certification extracts fields already defined in FormalLCELInstance. It is a definitional packaging result rather than an independent construction of those fields.
-/
...
/-- specified theorem-visible per-instance boundary for P4C universal
...
/-- Universal per-instance boundary corresponding directly to universal
certification. -/
...
/-- Every formal LCEL instance here has a certified overlay. -/
...
/-- Universal certification here closes unconditionally on the defined typed
LCEL carrier. -/
...
/-- Per-instance certification is equivalent to existence of the specified boundary
data package. -/
...
This is the specified obstruction boundary for the first open P4C constructor
obligation. -/
...
/-- Universal certification is equivalent to universal existence of the specified
