...
def decidableEq_FeatureTag : DecidableEq FeatureTag := inferInstance
def decidableEq_GoalTag : DecidableEq GoalTag := inferInstance
def decidableEq_TraceTag : DecidableEq TraceTag := inferInstance
