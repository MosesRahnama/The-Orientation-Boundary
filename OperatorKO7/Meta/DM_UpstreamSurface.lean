...
This module is a forwarding surface for imported order-type declarations. Its comments describe exports without release or workflow claims.
-/
...
upstreamable to Mathlib after namespace / dependency refinement. -/
...
/-- The defined repository already proves the full general-order surface. -/
...
/-- specified order-type package, exposed under the staging namespace. -/
