...
/-- Exactness package for the six-element canonical witness list. -/
...
/-- Membership in the canonical list is equivalent to being one of its six constructors. -/
...
/-- Combined exactness theorem for the finite canonical witness list. -/
