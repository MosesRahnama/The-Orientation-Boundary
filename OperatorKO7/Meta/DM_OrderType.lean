...
/-- Public name for Remark `rem:proof-theoretic-context`. Hydra/Goodstein comparison stays EXTERNAL. -/
theorem omega_pow_omega_mul_two_lt_epsilon0 :
    ((ω : Ordinal) ^ (ω : Ordinal)) * (2 : Nat) < ε₀ :=
  opow_omega_mul_two_lt_epsilon0
