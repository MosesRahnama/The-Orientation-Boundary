...
This module packages four explicit W1 construction witnesses and records the
structural import carried by each package. Its scope is those four packages.
