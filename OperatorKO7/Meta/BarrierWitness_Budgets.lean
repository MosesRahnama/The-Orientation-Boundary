...
This file proves an explicit construction-budget theorem: the generated step
payload is the base term, a successor chain `succIter k`, or a wrapper chain
`wrapIter k`, with a computable budget `k` read from the measure data.
-/
