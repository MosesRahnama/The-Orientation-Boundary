...
/-!
This module defines status metadata rows and re-exports selected imported propositions.
Membership lemmas establish the assigned enum values in the local list. Mathematical
certification resides in the imported propositions rather than the status labels.
