...
For the current disclosure policy, see [Disclosure_List.md](./Disclosure_List.md).
...
OperatorKO7/
  ...
  OrientationBoundaryAPI.lean     orientation-boundary surface
  PrimitiveSchemaAPI.lean         primitive-schema surface
  ResidualMethodAPI.lean          residual-closure surface
  SchemaAPI.lean                  schema-barrier surface
  SchemaExtendedAPI.lean          extended-schema surface
  Meta/                           selected public theorem modules
...
Disclosure_List.md                 public disclosure statement
README.md                          this file
...
The module-map appendices of *The Orientation Boundary for Step-Duplicating Recursors: Mechanized Impossibility, Escape, and Certification* and *Operational Inexpressibility at the Primitive-Recursion Orientation Boundary* remain the manuscript-level inventory of cited Lean modules.
